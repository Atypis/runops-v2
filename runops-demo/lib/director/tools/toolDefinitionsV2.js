...
Quick Testing - Position:
  ...
  return [
    ...
    ...domTools,
    {
      ...
      function: {
        name: 'iterate_apply',
        description: 'Update an iterate container\'s body_spec using natural NodeSelectorSpec and persist resolved child positions.',
        parameters: {
          type: 'object',
          properties: {
            ...
            iterateRef: {
              anyOf: [
                { type: 'string' },
                { type: 'number' },
                { type: 'object', properties: { alias: { type: 'string' }, position: { type: 'number' }, uuid: { type: 'string' } }, additionalProperties: false }
              ]
            },
            op: { type: 'string', enum: ['add', 'remove', 'replace', 'reorder'] },
            spec: { type: 'object', additionalProperties: true },
            reorder_spec: { type: 'object', additionalProperties: true }
          },
          required: ['workflowId', 'iterateRef', 'op'],
          additionalProperties: false
        },
        strict: true
      }
    },
    {
      type: 'function',
      function: {
        name: 'iterate_resolve',
        description: 'Resolve an iterate container\'s spec to concrete body_positions without changing the spec.',
        parameters: {
          type: 'object',
          properties: {
            workflowId: { type: 'string' },
          ...
          required: ['workflowId', 'iterateRef'],
          additionalProperties: false
        },
        strict: true
      }
    },
    {
      ...
      function: {
        name: 'route_apply',
        description: 'Update a route container\'s branch spec (branch_spec or paths_spec) and persist resolved branch_positions.',
        parameters: {
          type: 'object',
          properties: {
            workflowId: { type: 'string' },
            ...
            paths_spec: { type: 'object', additionalProperties: true }
          },
          required: ['workflowId', 'routeRef', 'op'],
          additionalProperties: false
        },
        strict: true
      }
    },
    {
      ...
      function: {
        name: 'route_resolve',
        description: 'Resolve a route container\'s branch specs to branch_positions without changing the specs.',
        parameters: {
          type: 'object',
          properties: {
            workflowId: { type: 'string' },
    ...
    },
    {
      type: 'function',
      function: {
        name: 'workflow_renumber_preorder',
        description: 'Renumber node positions to match pre-order traversal (container → children).',
        parameters: {
          type: 'object',
          properties: {
            workflowId: { type: 'string' }
